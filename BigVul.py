...
X_train, X_test_valid, y_train, y_test_valid = train_test_split(data.loc[:, data.columns != 'vul'],
                                                                data['vul'],
                                                                train_size=0.8,
                                                                stratify=data['vul']
                                                               )
X_test, X_valid, y_test, y_valid = train_test_split(X_test_valid.loc[:, X_test_valid.columns != 'vul'],
                                                    y_test_valid,
                                                    test_size=0.5,
...
dts = dts.remove_columns(['vul_func_with_fix', 'truncated_code', '__index_level_0__'])
dts["train"] = dts["train"].rename_column("vul", "label")
dts["test"] = dts["test"].rename_column("vul", "label")
dts["valid"] = dts["valid"].rename_column("vul", "label") 
